...
async function updateSongAPI(sa:typeof superagent, songChanges:ISong, auth:any): Promise<string> {
...
const addSongAPI = async (sa: typeof superagent, songBody:ISong, auth: { token: string; }): Promise<string> => {
