...
export class MusicPlayer extends Component {
    ...
    buttons() {
        ...
        return (
            <section
                className="mt-0 col-12 col-md-10"
                style={{ marginTop: "4px" }}>
                <button
                    type="button"
                    id="play-pause"
        ...
        return (
            <section
                ...
                <p
                    ...
                    {song !== null && song.album !== undefined
                        ? song.album
                        : null}
                    {song !== null && song.year !== undefined
                        ? `, ${song.year}`
                        : null}
                </p>
                <p
                    ...
                    {song !== null && song.category === "originals"
                        ? this.copyRight()
                        : null}
                </p>
            </section>
