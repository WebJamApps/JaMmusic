...
interface ImakeLinkProps {menu: ImenuItem, index: number, type: string, handleClose:any}
...
interface IsideMenuItemProps { 
  menu: ImenuItem, index: number, auth:any, location:any, dispatch:Dispatch<unknown>, handleClose:any,
}
