...
describe('CreateSongDialog', () => {
  ...
  it('handles onChange with url', () => {
    const showDialog = true;
    const setShowDialog = vi.fn();
    const { container } = render(<CreateSongDialog showDialog={showDialog} setShowDialog={setShowDialog} />);
    const input = container.querySelector('input[label="* Url"]')!;
  ...
  it('handles onChange with title', () => {
    ...
    const setShowDialog = vi.fn();
    const { container } = render(<CreateSongDialog showDialog={showDialog} setShowDialog={setShowDialog} />);
    const input = container.querySelector('input[label="* Title"]')!;
  ...
  it('handles onChange with artist', () => {
    ...
    const setShowDialog = vi.fn();
    const { container } = render(<CreateSongDialog showDialog={showDialog} setShowDialog={setShowDialog} />);
    const input = container.querySelector('input[label="* Artist"]')!;
  ...
  it('handles onChange with category', () => {
    ...
    const setShowDialog = vi.fn();
    const { container } = render(<CreateSongDialog showDialog={showDialog} setShowDialog={setShowDialog} />);
    const input = container.querySelector('input[label="Category"]')!;
  ...
  it('handles onChange with composer', () => {
    ...
    const setShowDialog = vi.fn();
    const { container } = render(<CreateSongDialog showDialog={showDialog} setShowDialog={setShowDialog} />);
    const input = container.querySelector('input[label="Composer"]')!;
  ...
  it('handles onChange with album', () => {
    ...
    const setShowDialog = vi.fn();
    const { container } = render(<CreateSongDialog showDialog={showDialog} setShowDialog={setShowDialog} />);
    const input = container.querySelector('input[label="Album"]')!;
  ...
  it('handles onChange with image', () => {
    ...
    const setShowDialog = vi.fn();
    const { container } = render(<CreateSongDialog showDialog={showDialog} setShowDialog={setShowDialog} />);
    const input = container.querySelector('input[label="Image"]')!;
  ...
  it('handles onChange with year', () => {
    ...
    const setShowDialog = vi.fn();
    const { container } = render(<CreateSongDialog showDialog={showDialog} setShowDialog={setShowDialog} />);
    const input = container.querySelector('input[label="* Year"]')!;
  ...
  it('handles onChange with orderBy', () => {
    ...
    const setShowDialog = vi.fn();
    const { container } = render(<CreateSongDialog showDialog={showDialog} setShowDialog={setShowDialog} />);
    const input = container.querySelector('input[label="Order (highest number plays first)"]')!;
    fireEvent.change(input, { target: { value: '2' } });
    expect(input).toBeDefined();
  });
});
